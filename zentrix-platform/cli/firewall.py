...
def main() -> int:
    parser = argparse.ArgumentParser(prog="zentrix-firewall")
    ...
    if "firewall" == "health":
      ...
      print("zentrix-firewall: command scaffold ready for next phases")
